...
default['mysql']['rpms'] = [
  {
    :url => 'http://downloads.mysql.com/archives/get/file/MySQL-shared-5.6.19-1.el6.x86_64.rpm',
    :file => 'MySQL-shared-5.6.19-1.el6.x86_64.rpm',
    :package_name => 'MySQL-shared'
  },
  {
    :url => 'http://downloads.mysql.com/archives/get/file/MySQL-server-5.6.19-1.el6.x86_64.rpm',
    :file => 'MySQL-server-5.6.19-1.el6.x86_64.rpm',
    :package_name => 'MySQL-server'
  },
  {
    :url => 'http://downloads.mysql.com/archives/get/file/MySQL-client-5.6.19-1.el6.x86_64.rpm',
    :file => 'MySQL-client-5.6.19-1.el6.x86_64.rpm',
    :package_name => 'MySQL-client'
  },
  {
    :url => 'http://downloads.mysql.com/archives/get/file/MySQL-devel-5.6.19-1.el6.x86_64.rpm',
